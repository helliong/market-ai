...
function AuthField({ icon, label, value, onChange, placeholder, type, error, focusBorder = "focus-within:border-[#6D4AFF]" }: {
  icon: React.ReactNode; label: string; value: string; onChange: (value: string) => void; placeholder: string; type: string; error?: string; focusBorder?: string;
}) {
  return (
    <label className="block">
