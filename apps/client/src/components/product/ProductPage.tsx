...
import { CheckCircle2, Heart, Minus, Plus, RotateCcw, Scale, ShieldCheck, ShoppingCart, Star, Truck } from "lucide-react";
...
type Product = { id: number; title: string; price: string; oldPrice?: string; rating: number; reviews: number; badge?: string; };
